...
/*
 *
 * Check if we have custom fields without a group
 * Only custom fields without a group are added to the first content tab
 * Set fields-0 to the ignoreFieldsets array to prevent it from being rendered twice
 *
*/

$customFieldsWithoutGroup = $form->getFieldset('fields-0');
if( count($customFieldsWithoutGroup) != 0 )
{
	$customFieldsWithoutGroup = array('fields-0' => $customFieldsWithoutGroup);
	$ignoreFieldsets[] = 'fields-0';
}
