...
$wa->registerAndUseStyle('all', 'administrator/templates/atum_new/css/all.min.css', []);
$wa->registerAndUseStyle('sharp-regular', 'administrator/templates/atum_new/css/sharp-regular.min.css', []);
$wa->registerAndUseStyle('sharp-solid', 'administrator/templates/atum_new/css/sharp-solid.min.css', []);
$wa->registerAndUseStyle('repeatable', 'administrator/templates/atum_new/css/repeatable.min.css', []);
$wa->registerAndUseStyle('custom', 'administrator/templates/atum_new/css/custom.min.css', []);
